...
int main(int argc, char *argv[]) {
    ...
    if (mx_strcmp(argv[2], "add") == 0 && argc == 5) {
        ...
        if (mx_strcmp(argv[3], "artist") == 0) {
            ...
            int *tmp = (int*)malloc((max_count + 1) * 4);
            ...
            int *tmp = (int*)malloc(max_count * 4);
            ...
            for (int i = 0; i < max_count; i++) {
                for (int j = 0; j < max_count - 1; j++) {
                    if (mx_strcmp_ignored(&arr[j][start_index[j]], &arr[j + 1][start_index[j + 1]]) > 0 ) {
                        char *data = arr[j];
                        arr[j] = arr[j + 1];
                        arr[j + 1] = data;
